...
namespace Tomlyn.Tests
{
    ...
    {
        public string? NullableMock { get; set; }

        public string NonNullableMock { get; set; } = string.Empty;
    }
    ...
    [TomlSourceGenerationOptions(
        ...
        Converters = new []{ typeof(GeneratedOptionsConverter) })]
    ...
    [TomlPolymorphic(TypeDiscriminatorPropertyName = "kind", UnknownDerivedTypeHandling = TomlUnknownDerivedTypeHandling.FallBackToBaseType)]
    [TomlDerivedType(typeof(GeneratedJsonAttrFallbackDerived), "derived")]
...
values = [10, 20, 10]";
            ...
            Assert.That(roundtrip, Is.Not.Null);
            Assert.That(roundtrip!.Numbers.SequenceEqual(payload.Numbers!), Is.True);
            Assert.That(roundtrip.Names!.SequenceEqual(payload.Names!), Is.True);
